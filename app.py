...
dataset = np.load('signLanguage-Dataset.npy')
X = dataset[:, :-1]
y = dataset[:, -1]
    ...
    try:
        with mp_hands.Hands(
            ...
            for idx, file in enumerate(IMAGE_FILES):
                ...
                print(img.shape)
                print(counter)
                imgPath = './images/marked/E/img' + str(counter) + '.png'
                skeletonPath = './images/skeleton/E/img' + str(counter) + '.png'
